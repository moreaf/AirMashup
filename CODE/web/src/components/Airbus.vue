<template>
  ...
  <v-layout align-center justify-center row wrap>
    <v-flex lg3 v-for="airbusModel in airbusModels">
       <v-card  v-bind:key="airbusModel.id" class="xxx indigo elevation-20 align-center justify-space-around">
          <img
            class="white--text"
            aspect-ratio = 4/3
            width="100%"
          ...
          <v-card-actions class="align-center justify-space-around">
            <v-btn class ="elevation-20 mb-3" color="yellow darken-4" dark @click="loadTour(airbusModel.name,airbusModel.lat,airbusModel.lon,airbusModel.range,airbusModel.description)" >LAUNCH MODEL</v-btn>
            <v-btn class ="elevation-20 mb-3" color="light-blue lighten-1" dark @click="initOrbit(airbusModel.name)">ORBIT</v-btn>
